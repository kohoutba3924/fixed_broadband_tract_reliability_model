...
The **Fixed Broadband Tract Reliability Model** is a data science and machine learning project focused on building a census tract‑level reliability index and predictive model. The project integrates multiple public datasets including Ookla network performance tiles and tract‑level weather climatology to quantify and model broadband reliability at a granular geographic level.
